      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl shadow-orange-100/50 border border-orange-100">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl border border-orange-200 bg-white text-gray-700 font-medium hover:bg-orange-50 transition-all duration-200 flex items-center justify-center gap-2"
          >
